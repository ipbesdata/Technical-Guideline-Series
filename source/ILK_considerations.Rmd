...
```{r, echo=FALSE}
htmltools::img(src = knitr::image_uri("C:/Users/jkumagai/Documents/IPBES/R/Geoinformatics/Technical Guidelines Series/ILK_considerations/logo2.png"), 
               alt = 'logo', 
...
### `r colorize("III. CARE and FPIC when working with different ILK sources", "green")`
...
### `r colorize("IV. Documentation for each type of source", "green")`

Finalised dialogue reports are openly available and published as open access on Zenodo. 

Data management reports^[For more information on data management tutorials, Chapter 3 of the IPBES data management tutorials reviews the topic in detail, which is available here: https://doi.org/10.5281/zenodo.4014792] should be used to document the process of working with other sources of ILK to enhance transparency. For data management reports that include descriptions of all ILK sources, a section describing the following for each source should be included:
